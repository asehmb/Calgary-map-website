...
from llm import extract_filter_with_llm, extract_filter_nlp_patterns
...
CORS(app, origins=["https://calgary-map-frontend.onrender.com", "http://localhost:3000"], supports_credentials=True)
